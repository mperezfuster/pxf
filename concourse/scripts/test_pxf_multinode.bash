...
function add_testing_encoding() {
	...
	ssh "${SSH_OPTS[@]}" gpadmin@mdw "source ${GPHOME}/greenplum_path.sh && gpssh -f ~gpadmin/hostfile_all -v -u centos -s -e 'sudo localedef -c -i ru_RU -f CP1251 ru_RU.CP1251' && gpstop -air"
}
